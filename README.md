...
Github Repo:
https://github.com/dilgerma/axoniq-conference-workshop
...
In this part of the workshop, we will divide into teams and work on the system Slices.

You will be assigned one of four Teams ( Team A, Team B, Team C, Team D)

Each Team will work on the corresponding Branch:
...
You will learn 3 things in this Workshop:
...
Pick a free slice, which nobody of YOUR Team is currently working on. Assign yourself to the Slice by moving a sticky note with your name to the top left corner of the slice.
...
### Code Structure
Slices are located directly "com.axoniqconf"
